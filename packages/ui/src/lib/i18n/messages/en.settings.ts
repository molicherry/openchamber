export const settingsDict = {
  ...
  'settings.providers.page.connect.modeBuiltin': 'Built-in',
  'settings.providers.page.connect.modeCustom': 'Custom',
  'settings.providers.page.connect.customProviderId': 'Provider ID',
  'settings.providers.page.connect.customProviderIdPlaceholder': 'my-custom-provider',
  'settings.providers.page.connect.customProviderIdTooltip': 'Unique identifier (lowercase, no spaces). Used as the provider key in configuration.',
  'settings.providers.page.connect.customProviderName': 'Display Name',
  'settings.providers.page.connect.customProviderNamePlaceholder': 'My Custom Provider',
  'settings.providers.page.connect.customBaseURL': 'Base URL',
  'settings.providers.page.connect.customBaseURLPlaceholder': 'https://api.example.com/v1',
  'settings.providers.page.connect.customBaseURLTooltip': 'API endpoint URL for this provider. Leave blank to use OpenAI default.',
  'settings.providers.page.connect.customApiKeyLabel': 'API Key',
  'settings.providers.page.connect.customModelId': 'Model ID',
  'settings.providers.page.connect.customModelIdPlaceholder': 'my-model',
  'settings.providers.page.connect.customModelName': 'Model Name',
  'settings.providers.page.connect.customModelNamePlaceholder': 'My Model',
  'settings.providers.page.connect.customContextLimit': 'Context Limit (tokens)',
  'settings.providers.page.connect.customContextLimitPlaceholder': '128000',
  'settings.providers.page.connect.customOutputLimit': 'Max Output (tokens)',
  'settings.providers.page.connect.customOutputLimitPlaceholder': '4096',
  'settings.providers.page.connect.customCreate': 'Create Provider',
  'settings.providers.page.connect.customCreating': 'Creating...',
  'settings.providers.page.toast.customProviderCreated': 'Custom provider created',
  'settings.providers.page.toast.customProviderCreateFailed': 'Failed to create custom provider',
  'settings.providers.page.toast.customProviderIdRequired': 'Provider ID is required',
  'settings.providers.page.toast.customModelIdRequired': 'Model ID is required',
  'settings.providers.page.toast.customModelNameRequired': 'Model name is required',
  'settings.providers.page.toast.customContextLimitInvalid': 'Context limit must be a positive number',
  'settings.providers.page.toast.customOutputLimitInvalid': 'Max output must be a positive number',
  'settings.providers.page.endpoint.title': 'Endpoint',
  'settings.providers.page.endpoint.baseURL.label': 'Base URL',
  'settings.providers.page.endpoint.baseURL.placeholder': 'https://api.openai.com/v1',
  'settings.providers.page.endpoint.baseURL.tooltip': 'Override the default API endpoint for this provider. Useful for proxies or OpenAI-compatible services.',
  'settings.providers.page.endpoint.baseURL.saved': 'Endpoint base URL saved',
  'settings.providers.page.endpoint.baseURL.saveFailed': 'Failed to save endpoint base URL',
  'settings.providers.page.endpoint.baseURL.cleared': 'Endpoint base URL cleared (using default)',
  'settings.providers.page.endpoint.baseURL.save': 'Save',
